    ...
    <div class="row">
        ...
        <nav class="navbar">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="index.php">Parking Pass</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="../visitor.php">Log in</a>
                </li>
            </ul>
            </div>
        </nav>
  ...
  <main>
    ...
    <section id="payment-section" class="hidden">
      ...
      <form id="payment-form">
        ...
        <label for="license-plate-input">License Plate Number:</label>
        <input type="text" id="license-plate-input" required pattern="[A-Z]{3}-\d{4}">
