...
<html lang="en">
    <head>
        ...
        <meta name="description" content ="This queries the alerts table in sql and displays the table.">
        ...
        <main>
            <div class="triggertable">
                <?php 
                    ...
                    $result = mysqli_query($conn, "SELECT * FROM ALERTS");
                    $rows = "";
                    ...
                    $table = "<table><thead><tr><th>Message ID</th><th>Member ID</th><th>Message</th>
                    <th>Created At</th></tr></thead><tbody>" . $rows . "</tbody></table>";
