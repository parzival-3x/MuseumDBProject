...
ticketForm.addEventListener('submit', function(event) {
  ...
  if (totalPrice === '0') {
    alert('You have selected a free ticket. No payment is required.');
    location.reload();
  } else {
